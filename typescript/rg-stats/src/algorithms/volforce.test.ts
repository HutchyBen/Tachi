...
test("VF4 Tests", () => {
	...
	for (const data of VF4ExampleData) {
		...
		).toBe(data.expectedVF4);
	}
});

test("VF4 Validation Tests", () => {
	expectThrowsSnapshot(
		() => calculateVF4(10_000_001, 20),
		"Should throw if score is greater than 10 million.",
	);

	expectThrowsSnapshot(() => calculateVF4(-1, 20), "Should throw if score is negative.");
...
test("VF6 Tests", () => {
	...
	const VF5ExampleData = [
		...
		VF6TestCase(18, 9_923_042, "MAXXIVE CLEAR", 0.39),
