...
import * as chunithm_playlog_pb from "../chunithm/playlog_pb";
...
export class GetPlaylogStreamItem extends jspb.Message {
	...
	hasInfo(): boolean;
	clearInfo(): void;
	getInfo(): chunithm_playlog_pb.PlaylogInfo | undefined;
	setInfo(value?: chunithm_playlog_pb.PlaylogInfo): void;

	hasJudge(): boolean;
	clearJudge(): void;
	getJudge(): chunithm_playlog_pb.PlaylogJudge | undefined;
	setJudge(value?: chunithm_playlog_pb.PlaylogJudge): void;

	serializeBinary(): Uint8Array;
	toObject(includeInstance?: boolean): GetPlaylogStreamItem.AsObject;
	static toObject(
		includeInstance: boolean,
		msg: GetPlaylogStreamItem,
	): GetPlaylogStreamItem.AsObject;
	static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
	static extensionsBinary: { [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message> };
...
export namespace GetPlaylogStreamItem {
	export type AsObject = {
		playlogApiId: string;
		info?: chunithm_playlog_pb.PlaylogInfo.AsObject;
		judge?: chunithm_playlog_pb.PlaylogJudge.AsObject;
	};
}
