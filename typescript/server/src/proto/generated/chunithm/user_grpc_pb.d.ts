...
interface IChunithmUserService extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
	getPlaylog: grpc.MethodDefinition<
		chunithm_user_pb.GetPlaylogRequest,
		chunithm_user_pb.GetPlaylogStreamItem
	>;
}
...
export class ChunithmUserClient extends grpc.Client {
	...
	getPlaylog(
		argument: chunithm_user_pb.GetPlaylogRequest,
		metadataOrOptions?: grpc.Metadata | grpc.CallOptions | null,
	): grpc.ClientReadableStream<chunithm_user_pb.GetPlaylogStreamItem>;
	getPlaylog(
		argument: chunithm_user_pb.GetPlaylogRequest,
