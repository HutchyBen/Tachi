...
export class PlaylogInfo extends jspb.Message {
	...
	setLevel(
		value: chunithm_common_pb.ChunithmLevelMap[keyof chunithm_common_pb.ChunithmLevelMap],
	): void;
	...
	setScoreRank(
		value: chunithm_common_pb.ChunithmScoreRankMap[keyof chunithm_common_pb.ChunithmScoreRankMap],
	): void;

	getComboStatus(): chunithm_common_pb.ChunithmComboStatusMap[keyof chunithm_common_pb.ChunithmComboStatusMap];
	setComboStatus(
		value: chunithm_common_pb.ChunithmComboStatusMap[keyof chunithm_common_pb.ChunithmComboStatusMap],
	): void;

	getFullChainStatus(): chunithm_common_pb.ChunithmFullChainStatusMap[keyof chunithm_common_pb.ChunithmFullChainStatusMap];
	setFullChainStatus(
		value: chunithm_common_pb.ChunithmFullChainStatusMap[keyof chunithm_common_pb.ChunithmFullChainStatusMap],
	): void;

	getClearStatus(): chunithm_common_pb.ChunithmClearStatusMap[keyof chunithm_common_pb.ChunithmClearStatusMap];
	setClearStatus(
		value: chunithm_common_pb.ChunithmClearStatusMap[keyof chunithm_common_pb.ChunithmClearStatusMap],
	): void;
