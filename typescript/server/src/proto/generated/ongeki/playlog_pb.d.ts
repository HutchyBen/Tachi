...
export class PlaylogInfo extends jspb.Message {
	...
	setTechScoreRank(
		value: ongeki_common_pb.OngekiTechScoreRankMap[keyof ongeki_common_pb.OngekiTechScoreRankMap],
	): void;

	getBattleScoreRank(): ongeki_common_pb.OngekiBattleScoreRankMap[keyof ongeki_common_pb.OngekiBattleScoreRankMap];
	setBattleScoreRank(
		value: ongeki_common_pb.OngekiBattleScoreRankMap[keyof ongeki_common_pb.OngekiBattleScoreRankMap],
	): void;

	getComboStatus(): ongeki_common_pb.OngekiComboStatusMap[keyof ongeki_common_pb.OngekiComboStatusMap];
	setComboStatus(
		value: ongeki_common_pb.OngekiComboStatusMap[keyof ongeki_common_pb.OngekiComboStatusMap],
	): void;

	getClearStatus(): ongeki_common_pb.OngekiClearStatusMap[keyof ongeki_common_pb.OngekiClearStatusMap];
	setClearStatus(
		value: ongeki_common_pb.OngekiClearStatusMap[keyof ongeki_common_pb.OngekiClearStatusMap],
	): void;
...
export class PlaylogMatchingUser extends jspb.Message {
	...
	setMusicLevel(
		value: ongeki_common_pb.OngekiLevelMap[keyof ongeki_common_pb.OngekiLevelMap],
	): void;
	...
	static toObject(
		...
		msg: PlaylogMatchingUser,
	): PlaylogMatchingUser.AsObject;
	static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
	static extensionsBinary: { [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message> };
...
export class PlaylogBoss extends jspb.Message {
	...
	setBossAttribute(
		value: ongeki_common_pb.OngekiBossAttributeMap[keyof ongeki_common_pb.OngekiBossAttributeMap],
	): void;
