...
if (goog.DEBUG && !COMPILED) {
	 ...
	 * @override
	 */
	proto.mythos.ongeki.v0.PlaylogMatchingUser.displayName =
		"proto.mythos.ongeki.v0.PlaylogMatchingUser";
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
	...
	while (reader.nextField()) {
		...
		switch (field) {
			...
			case 6:
				...
				break;
			case 7:
				var value = /** @type {!proto.mythos.ongeki.v0.OngekiTechScoreRank} */ (
					reader.readEnum()
				);
				msg.setTechScoreRank(value);
				break;
			case 8:
				var value = /** @type {!proto.mythos.ongeki.v0.OngekiBattleScoreRank} */ (
					reader.readEnum()
				);
				msg.setBattleScoreRank(value);
				break;
			case 9:
				var value = /** @type {!proto.mythos.ongeki.v0.OngekiComboStatus} */ (
					reader.readEnum()
				);
				msg.setComboStatus(value);
				break;
			case 10:
				var value = /** @type {!proto.mythos.ongeki.v0.OngekiClearStatus} */ (
					reader.readEnum()
				);
...
proto.mythos.ongeki.v0.PlaylogInfo.prototype.getLevel = function () {
	return /** @type {!proto.mythos.ongeki.v0.OngekiLevel} */ (
...
proto.mythos.ongeki.v0.PlaylogInfo.prototype.getTechScoreRank = function () {
	return /** @type {!proto.mythos.ongeki.v0.OngekiTechScoreRank} */ (
...
proto.mythos.ongeki.v0.PlaylogInfo.prototype.getBattleScoreRank = function () {
	return /** @type {!proto.mythos.ongeki.v0.OngekiBattleScoreRank} */ (
...
proto.mythos.ongeki.v0.PlaylogInfo.prototype.getComboStatus = function () {
	return /** @type {!proto.mythos.ongeki.v0.OngekiComboStatus} */ (
...
proto.mythos.ongeki.v0.PlaylogInfo.prototype.getClearStatus = function () {
	return /** @type {!proto.mythos.ongeki.v0.OngekiClearStatus} */ (
	...
	while (reader.nextField()) {
		...
		switch (field) {
			...
			case 2:
				...
				break;
			case 3:
				var value = /** @type {!proto.mythos.ongeki.v0.OngekiBossAttribute} */ (
					reader.readEnum()
				);
...
proto.mythos.ongeki.v0.PlaylogBoss.prototype.getBossAttribute = function () {
	return /** @type {!proto.mythos.ongeki.v0.OngekiBossAttribute} */ (
