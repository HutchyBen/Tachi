...
if (goog.DEBUG && !COMPILED) {
	 ...
	 * @override
	 */
	proto.mythos.ongeki.v0.GetPlaylogRequest.displayName =
		"proto.mythos.ongeki.v0.GetPlaylogRequest";
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
if (goog.DEBUG && !COMPILED) {
	 ...
	 * @override
	 */
	proto.mythos.ongeki.v0.GetPlaylogStreamItem.displayName =
		"proto.mythos.ongeki.v0.GetPlaylogStreamItem";
}
...
if (jspb.Message.GENERATE_TO_OBJECT) {
	 ...
	 * @return {!Object}
	 */
	proto.mythos.ongeki.v0.GetPlaylogStreamItem.prototype.toObject = function (
		opt_includeInstance,
	) {
	...
	proto.mythos.ongeki.v0.GetPlaylogStreamItem.toObject = function (includeInstance, msg) {
		var f,
			obj = {
				...
				info:
					(f = msg.getInfo()) &&
					ongeki_playlog_pb.PlaylogInfo.toObject(includeInstance, f),
				judge:
					(f = msg.getJudge()) &&
					ongeki_playlog_pb.PlaylogJudge.toObject(includeInstance, f),
			};
	...
	while (reader.nextField()) {
		...
		switch (field) {
			...
			case 2:
				...
				reader.readMessage(
					value,
					ongeki_playlog_pb.PlaylogInfo.deserializeBinaryFromReader,
				);
				msg.setInfo(value);
				break;
			case 3:
				...
				reader.readMessage(
					value,
					ongeki_playlog_pb.PlaylogJudge.deserializeBinaryFromReader,
				);
				msg.setJudge(value);
				break;
			default:
...
proto.mythos.ongeki.v0.GetPlaylogStreamItem.serializeBinaryToWriter = function (message, writer) {
	...
	f = message.getInfo();
	if (f != null) {
		writer.writeMessage(2, f, ongeki_playlog_pb.PlaylogInfo.serializeBinaryToWriter);
	}
	f = message.getJudge();
	if (f != null) {
		writer.writeMessage(3, f, ongeki_playlog_pb.PlaylogJudge.serializeBinaryToWriter);
	}
};
