...
export namespace DataResponse {
	...
	export namespace VersionData {
		...
		export class LastSong extends jspb.Message {
			...
			setMusicDifficulty(
				value: wacca_common_pb.WaccaMusicDifficultyMap[keyof wacca_common_pb.WaccaMusicDifficultyMap],
			): void;
...
export class PlaylogInfo extends jspb.Message {
	...
	setGrade(
		value: wacca_common_pb.WaccaMusicScoreGradeMap[keyof wacca_common_pb.WaccaMusicScoreGradeMap],
	): void;
	...
	setUserPlayMode(
		value: wacca_common_pb.WaccaPlayModeMap[keyof wacca_common_pb.WaccaPlayModeMap],
	): void;
