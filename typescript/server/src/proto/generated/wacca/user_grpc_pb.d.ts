...
interface IWaccaUserService extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
	...
	getPlaylog: grpc.MethodDefinition<
		wacca_user_pb.PlaylogRequest,
		wacca_user_pb.PlaylogStreamItem
	>;
}
...
export class WaccaUserClient extends grpc.Client {
	...
	getData(
		argument: wacca_user_pb.DataRequest,
		callback: grpc.requestCallback<wacca_user_pb.DataResponse>,
	...
	getPlaylog(
		argument: wacca_user_pb.PlaylogRequest,
		metadataOrOptions?: grpc.Metadata | grpc.CallOptions | null,
	): grpc.ClientReadableStream<wacca_user_pb.PlaylogStreamItem>;
	getPlaylog(
		argument: wacca_user_pb.PlaylogRequest,
		metadata?: grpc.Metadata | null,
		options?: grpc.CallOptions | null,
