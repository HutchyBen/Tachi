...
proto.mythos.wacca.v0.DataResponse = function (opt_data) {
	jspb.Message.initialize(
		...
		0,
		-1,
		proto.mythos.wacca.v0.DataResponse.repeatedFields_,
		null,
	);
};
...
proto.mythos.wacca.v0.DataResponse.VersionData = function (opt_data) {
	jspb.Message.initialize(
		...
		0,
		-1,
		proto.mythos.wacca.v0.DataResponse.VersionData.repeatedFields_,
		null,
	);
};
...
if (goog.DEBUG && !COMPILED) {
	 ...
	 * @override
	 */
	proto.mythos.wacca.v0.DataResponse.VersionData.displayName =
...
if (goog.DEBUG && !COMPILED) {
	 ...
	 * @override
	 */
	proto.mythos.wacca.v0.DataResponse.VersionData.LastSong.displayName =
		"proto.mythos.wacca.v0.DataResponse.VersionData.LastSong";
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
	...
	proto.mythos.wacca.v0.DataResponse.toObject = function (includeInstance, msg) {
		var f,
			obj = {
				...
				favoriteMusicEntriesList:
					(f = jspb.Message.getRepeatedField(msg, 4)) == null ? undefined : f,
				versionDataMap: (f = msg.getVersionDataMap())
					? f.toObject(
							includeInstance,
							proto.mythos.wacca.v0.DataResponse.VersionData.toObject,
						)
					: [],
			};
			...
			case 5:
				...
				reader.readMessage(value, function (message, reader) {
					jspb.Map.deserializeBinary(
						...
						proto.mythos.wacca.v0.DataResponse.VersionData.deserializeBinaryFromReader,
						0,
						new proto.mythos.wacca.v0.DataResponse.VersionData(),
					);
				});
				break;
			default:
...
proto.mythos.wacca.v0.DataResponse.serializeBinaryToWriter = function (message, writer) {
	...
	if (f && f.getLength() > 0) {
		f.serializeBinary(
			...
			proto.mythos.wacca.v0.DataResponse.VersionData.serializeBinaryToWriter,
		);
	}
};
...
if (jspb.Message.GENERATE_TO_OBJECT) {
	 ...
	 * @return {!Object}
	 */
	proto.mythos.wacca.v0.DataResponse.VersionData.prototype.toObject = function (
		opt_includeInstance,
	) {
	...
	proto.mythos.wacca.v0.DataResponse.VersionData.toObject = function (includeInstance, msg) {
		var f,
			obj = {
				...
				lastSong:
					(f = msg.getLastSong()) &&
					proto.mythos.wacca.v0.DataResponse.VersionData.LastSong.toObject(
						includeInstance,
						f,
					),
				...
				tutorialStateMap: (f = msg.getTutorialStateMap())
 ...
 * @return {!proto.mythos.wacca.v0.DataResponse.VersionData}
 */
proto.mythos.wacca.v0.DataResponse.VersionData.deserializeBinaryFromReader = function (
	msg,
	reader,
) {
	while (reader.nextField()) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.mythos.wacca.v0.DataResponse.VersionData.serializeBinaryToWriter = function (
	message,
	writer,
) {
	var f = undefined;
...
if (jspb.Message.GENERATE_TO_OBJECT) {
	 ...
	 * @return {!Object}
	 */
	proto.mythos.wacca.v0.DataResponse.VersionData.LastSong.prototype.toObject = function (
		opt_includeInstance,
	) {
		return proto.mythos.wacca.v0.DataResponse.VersionData.LastSong.toObject(
			opt_includeInstance,
			this,
		);
	};
	 ...
	 * @suppress {unusedLocalVariables} f is only used for nested messages
	 */
	proto.mythos.wacca.v0.DataResponse.VersionData.LastSong.toObject = function (
		includeInstance,
		msg,
	) {
		var f,
...
proto.mythos.wacca.v0.DataResponse.VersionData.LastSong.deserializeBinary = function (bytes) {
	...
	return proto.mythos.wacca.v0.DataResponse.VersionData.LastSong.deserializeBinaryFromReader(
		msg,
		reader,
	);
};
 ...
 * @return {!proto.mythos.wacca.v0.DataResponse.VersionData.LastSong}
 */
proto.mythos.wacca.v0.DataResponse.VersionData.LastSong.deserializeBinaryFromReader = function (
	msg,
	reader,
) {
	while (reader.nextField()) {
		...
		switch (field) {
			case 1:
				...
				break;
			case 2:
				var value = /** @type {!proto.mythos.wacca.v0.WaccaMusicDifficulty} */ (
					reader.readEnum()
				);
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.mythos.wacca.v0.DataResponse.VersionData.LastSong.serializeBinaryToWriter = function (
	message,
	writer,
) {
	var f = undefined;
...
proto.mythos.wacca.v0.DataResponse.VersionData.LastSong.prototype.getMusicDifficulty = function () {
	return /** @type {!proto.mythos.wacca.v0.WaccaMusicDifficulty} */ (
 ...
 * @return {!proto.mythos.wacca.v0.DataResponse.VersionData.LastSong} returns this
 */
proto.mythos.wacca.v0.DataResponse.VersionData.LastSong.prototype.setMusicDifficulty = function (
	value,
) {
 ...
 * @return {!proto.mythos.wacca.v0.DataResponse.VersionData} returns this
 */
proto.mythos.wacca.v0.DataResponse.VersionData.prototype.addTitlePartIds = function (
	value,
	opt_index,
) {
 ...
 */
proto.mythos.wacca.v0.DataResponse.VersionData.prototype.getTutorialStateMap = function (
	opt_noLazyCreate,
) {
	...
	proto.mythos.wacca.v0.PlaylogStreamItem.toObject = function (includeInstance, msg) {
		var f,
			obj = {
				...
				info:
					(f = msg.getInfo()) &&
					proto.mythos.wacca.v0.PlaylogInfo.toObject(includeInstance, f),
			};
	...
	while (reader.nextField()) {
		...
		switch (field) {
			...
			case 2:
				...
				reader.readMessage(
					value,
					proto.mythos.wacca.v0.PlaylogInfo.deserializeBinaryFromReader,
				);
				msg.setInfo(value);
				break;
			default:
...
proto.mythos.wacca.v0.PlaylogStreamItem.serializeBinaryToWriter = function (message, writer) {
	...
	f = message.getInfo();
	if (f != null) {
		writer.writeMessage(2, f, proto.mythos.wacca.v0.PlaylogInfo.serializeBinaryToWriter);
	}
};
	...
	proto.mythos.wacca.v0.PlaylogInfo.toObject = function (includeInstance, msg) {
		var f,
			obj = {
				...
				judge:
					(f = msg.getJudge()) && wacca_common_pb.WaccaJudge.toObject(includeInstance, f),
				clearStatus:
					(f = msg.getClearStatus()) &&
					wacca_common_pb.WaccaClearStatus.toObject(includeInstance, f),
	...
	while (reader.nextField()) {
		...
		switch (field) {
			...
			case 3:
				...
				break;
			case 4:
				var value = /** @type {!proto.mythos.wacca.v0.WaccaMusicScoreGrade} */ (
					reader.readEnum()
				);
				msg.setGrade(value);
				break;
			...
			case 6:
				...
				reader.readMessage(
					value,
					wacca_common_pb.WaccaClearStatus.deserializeBinaryFromReader,
				);
...
proto.mythos.wacca.v0.PlaylogInfo.serializeBinaryToWriter = function (message, writer) {
	...
	f = message.getJudge();
	if (f != null) {
		writer.writeMessage(5, f, wacca_common_pb.WaccaJudge.serializeBinaryToWriter);
	}
	f = message.getClearStatus();
	if (f != null) {
		writer.writeMessage(6, f, wacca_common_pb.WaccaClearStatus.serializeBinaryToWriter);
	}
...
proto.mythos.wacca.v0.PlaylogInfo.prototype.getGrade = function () {
	return /** @type {!proto.mythos.wacca.v0.WaccaMusicScoreGrade} */ (
...
proto.mythos.wacca.v0.PlaylogInfo.prototype.getUserPlayMode = function () {
	return /** @type {!proto.mythos.wacca.v0.WaccaPlayMode} */ (
