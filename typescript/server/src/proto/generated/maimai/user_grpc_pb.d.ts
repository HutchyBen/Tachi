...
interface IMaimaiUserService extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
	getPlaylog: grpc.MethodDefinition<
		maimai_user_pb.GetPlaylogRequest,
		maimai_user_pb.GetPlaylogStreamItem
	>;
}
...
export class MaimaiUserClient extends grpc.Client {
	...
	getPlaylog(
		argument: maimai_user_pb.GetPlaylogRequest,
		metadataOrOptions?: grpc.Metadata | grpc.CallOptions | null,
	): grpc.ClientReadableStream<maimai_user_pb.GetPlaylogStreamItem>;
	getPlaylog(
		argument: maimai_user_pb.GetPlaylogRequest,
