	...
	while (reader.nextField()) {
		...
		switch (field) {
			...
			case 4:
				...
				break;
			case 5:
				var value = /** @type {!proto.mythos.maimai.v0.MaimaiScoreRank} */ (
					reader.readEnum()
				);
				msg.setScoreRank(value);
				break;
			case 6:
				var value = /** @type {!proto.mythos.maimai.v0.MaimaiComboStatus} */ (
					reader.readEnum()
				);
				msg.setComboStatus(value);
				break;
			case 7:
				var value = /** @type {!proto.mythos.maimai.v0.MaimaiSyncStatus} */ (
					reader.readEnum()
				);
...
proto.mythos.maimai.v0.PlaylogInfo.prototype.getLevel = function () {
	return /** @type {!proto.mythos.maimai.v0.MaimaiLevel} */ (
...
proto.mythos.maimai.v0.PlaylogInfo.prototype.getScoreRank = function () {
	return /** @type {!proto.mythos.maimai.v0.MaimaiScoreRank} */ (
...
proto.mythos.maimai.v0.PlaylogInfo.prototype.getComboStatus = function () {
	return /** @type {!proto.mythos.maimai.v0.MaimaiComboStatus} */ (
...
proto.mythos.maimai.v0.PlaylogInfo.prototype.getSyncStatus = function () {
	return /** @type {!proto.mythos.maimai.v0.MaimaiSyncStatus} */ (
